...
Skip to main content
        ...
        <\/script> <!-- END CLICKCEASE --> <!-- Google Tag Manager (noscript) --> <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TDFV4QVJ" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> <!-- End Google Tag Manager (noscript) --> <!-- Register Service Worker for PWA (Deferred) --> <script>
        ...
        <\/script> `, " <!-- Scroll to Top Button --> ", " </body> </html>"])), addAttribute(Astro2.generator, "content"), fullTitle, addAttribute(fullTitle, "content"), addAttribute(description, "content"), addAttribute(canonicalURL, "href"), noindex && renderTemplate`<meta name="robots" content="noindex, nofollow">`, addAttribute(canonicalURL, "content"), addAttribute(fullTitle, "content"), addAttribute(description, "content"), addAttribute(ogImageURL, "content"), addAttribute(canonicalURL, "content"), addAttribute(fullTitle, "content"), addAttribute(description, "content"), addAttribute(ogImageURL, "content"), !noindex && renderTemplate`<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">`, allSchema.map((schemaItem) => renderTemplate(_a || (_a = __template(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(JSON.stringify(schemaItem)))), maybeRenderHead(), renderTemplate(_b || (_b = __template(["<script async defer", "><\/script>"])), addAttribute(`https://www.google.com/recaptcha/api.js?render=${"6LdFn6krAAAAAJXaiq0hr8p3fTd4L9RQr5p0giwR"}`, "src")), renderHead(), renderSlot($$result, $$slots["default"]), renderComponent($$result, "ScrollToTop", $$ScrollToTop, {}));
