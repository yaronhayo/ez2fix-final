...
import { z } from "zod";
import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from "./consts-SwzM8zyA.js";
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, r as renderComponent } from "./astro/server-Bk6MH9UW.js";
import "piccolore";
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import("./_astro_data-layer-content-Db3antQ6.js");
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_GOOGLE_ADS_CONVERSION_ID": "", "PUBLIC_GOOGLE_ADS_CONVERSION_LABEL": "", "PUBLIC_GOOGLE_ANALYTICS_ID": "G-XXXXXXXXXX", "PUBLIC_GOOGLE_MAPS_API_KEY": "AIzaSyCC7AYmLnyP7XLdADdhYFpzRRjiCqmlkhw", "PUBLIC_MICROSOFT_UET_TAG_ID": "", "PUBLIC_NOTIFICATION_EMAIL": "ez2fixllc@gmail.com", "PUBLIC_RECAPTCHA_SITE_KEY": "6LdFn6krAAAAAJXaiq0hr8p3fTd4L9RQr5p0giwR", "PUBLIC_SITE_URL": "https://ez2fixllc.com", "SITE": "https://ez2fixllc.com", "SSR": true };
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./_astro_assets-kICwUt0b.js").then((n) => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import("./content-modules-CAR4Bhjv.js");
