import { c as createComponent, m as maybeRenderHead, r as renderComponent, b as addAttribute, e as renderScript, a as renderTemplate } from "./astro/server-Bk6MH9UW.js";
import "piccolore";
import { I as Icon, $ as $$Button, s as siteConfig } from "./Footer-CJD9vIqY.js";
const services = [
  {
    id: "emergency-repair",
    ...
    heroImage: "/images/services/emergency-repair-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/spring-repair-v3.webp",
    heroBanner: "/images/services/spring-repair-banner.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/opener-installation-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/door-installation-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/opener-repair-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/cable-repair-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/panel-replacement-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/track-repair-v3.webp",
  ...
  },
  {
    ...
    heroImage: "/images/services/commercial-garage-door-v3.webp",
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="fixed w-full top-0 z-50 transition-all duration-300 bg-white/95 backdrop-blur-md shadow-sm" id="main-header"> <div class="container mx-auto px-2 sm:px-4 lg:px-6"> <div class="flex items-center justify-between h-16 sm:h-20"> <!-- Logo --> <a href="/" class="flex items-center flex-shrink-0"> <img src="/images/logos/ez2fix-logo.png" alt="Ez2Fix Garage Doors" width="180" height="48" class="h-10 w-auto transition-transform duration-300 group-hover:scale-105"> </a> <!-- Desktop Navigation --> <nav class="hidden xl:flex items-center space-x-6"> ${navLinks.map((link) => {
