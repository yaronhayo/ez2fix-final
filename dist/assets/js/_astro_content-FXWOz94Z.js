...
import { z } from "zod";
import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from "./Footer-Cs5b5W4u.js";
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent } from "./astro/server-BJ6_oM5W.js";
import "piccolore";
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import("./Footer-Cs5b5W4u.js").then((n) => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import("./content-modules-CJ6nmaQT.js");
